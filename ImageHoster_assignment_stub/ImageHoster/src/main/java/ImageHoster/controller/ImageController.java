...
public class ImageController {
    ...
    //This method first checks if the user can edit the image
    // It then fetches the image with the corresponding id from the database and adds it to the model with the key as 'image'
    ...
    public String editImage(@PathVariable(name = "imageId") Integer imageId, @PathVariable(name = "title") String title, Model model) {
    ...
    //The method first checks if the user can delete the image
    // and then calls the deleteImage() method in the business logic passing the id of the image to be deleted
